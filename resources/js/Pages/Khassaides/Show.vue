  ...
  <MainLayout>
    <div class="max-w-3xl mx-auto px-4 py-10">
      ...
      <div class="bg-gradient-to-r from-[#0d2f6e] to-[#1a4db5] rounded-2xl p-8 mb-6 text-white relative overflow-hidden">
        ...
        <div class="relative z-10 flex items-start gap-4">
          ...
          <div class="flex-1">
            ...
            <p v-if="khassaide.interprete" class="text-[#c9973a] text-sm mt-0.5 flex items-center gap-1">
              <MicrophoneIcon class="w-3.5 h-3.5" />
              {{ khassaide.interprete }}
            </p>
            <span v-if="khassaide.telechargeable" class="mt-3 inline-flex items-center gap-1 text-xs px-3 py-1 rounded-full bg-[#c9973a]/80 font-medium">
      ...
      <div v-if="khassaide.fichier_audio" class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 mb-6">
        ...
        <audio controls class="w-full" :src="`/storage/${khassaide.fichier_audio}`"></audio>
        <a
      ...
      <!-- Description -->
      <div v-if="khassaide.description" class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
...
import {
  ...
  SpeakerWaveIcon, InformationCircleIcon, MicrophoneIcon,
